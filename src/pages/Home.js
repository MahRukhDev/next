      ...
      <div className="homeMainBanner">
        <div className="container">
          <div className="homeBannerContent">
            <h1>NILWIRE <span>NFT MARKETPLACE</span></h1>
            <h6>Ballers Series Collection Coming Soon</h6>
            <a href="/create" className="btnLarge">Create Your Digital Assets Now</a>
          </div>
        </div>
      </div>
        ...
        <section className="homeVisionMisson">
          <div className="container">
            <div className="mvHomeBg">
              ...
              <p>Our mission is to help athletes monetize their name, image, and likeness utilizing blockchain technology and bringing value to their fans.</p>
              <p>NILWIRE is building a community where athletes, fans, and influencers can connect on a peer to peer marketplace. Our vision is to help athletes beyond sports and provide them a network with fans on another level.</p>
            </div>
          </div>
        </section>
                      ...
                      return (
                        <li>
                          <div className="author_list_pp">
                            ...
                            >
                              {data && data.userInfo && data.userInfo.image ? (
                                <img
                                  className="lazy"
              ...
              <div className="row">
                ...
                <div className="col-md-7">
                  <div className="homeFanContent">
                    ...
                    <p>NILWIRE is a fan first NFT marketplace created by brothers/former athletes to connect fans and athletes together. We offer collections created solely by athletes and premier artists to foster a community with the fans.</p>
                    <a href="/exclusive" className="btnLarge">Buy Your Digital Assets Now</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="collageContent">
                <div className="row">
                  ...
                  <div className="homeFanContent">
                    ...
                    <p>NILWIRE was created by brothers/former athletes who saw an opportunity in the NIL space to help athletes enhance their brand. We are passionate in building a community using NFT marketplace technology and their smart contract capabilities.</p>
                    <p>NILWIRE strives to be a marketplace hosting premier athletes from all over the country to bring value and experiences to fans like never before.</p>
